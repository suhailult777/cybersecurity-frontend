            ...
            <div className="flex-1 w-full lg:w-2/5 p-4 lg:p-8 flex items-center justify-center min-h-[50vh]">
                <div className="w-full max-w-[90%] lg:max-w-[400px] space-y-4 lg:space-y-6 pb-4">
                    <div className="flex justify-between items-center">
                        <h2 className="text-lg lg:text-xl font-medium text-cyan-400">LOGIN</h2>
                        <button className="text-cyan-400 text-xs lg:text-sm hover:text-cyan-300">
                            REGISTER
                        </button>
                    </div>
                    ...
                    <form className="space-y-4 lg:space-y-6">
                        <div className="space-y-1 lg:space-y-2">
                            <label className="block text-xs lg:text-sm text-cyan-400">Email</label>
                            <input
                                type="email"
                        ...
                        <div className="space-y-1 lg:space-y-2">
                            <label className="block text-xs lg:text-sm text-cyan-400">Password</label>
                            <input
                                type="password"
                                className="w-full text-sm lg:text-base bg-gray-800/50 border border-gray-700 rounded-sm p-2 lg:p-2.5 text-gray-100 focus:outline-none focus:border-cyan-400"
                            ...
                            <div className="flex justify-end">
                                <button type="button" className="text-cyan-400 text-[10px] lg:text-xs hover:text-cyan-300">
                                    FORGOT PASSWORD?
                                </button>
                            </div>
                        </div>
                        ...
                        <button
                            type="submit"
                            className="w-full text-sm lg:text-base bg-cyan-500/20 text-cyan-400 p-2 lg:p-2.5 rounded-sm hover:bg-cyan-500/30 transition-colors" onClick={handleLogin}>
                            LOGIN
                        </button>
                    </form>
                </div>
